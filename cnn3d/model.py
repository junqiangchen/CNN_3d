...
def create_conv_net(X, image_z, image_width, image_height, image_channel, image_labels, drop_conv, drop_hidden):
    # CNN model
...
class cnn3dModule(object):
    ...
    def __init__(self, image_z, image_height, image_width, channels=3, n_class=2, costname="cross_entropy"):
        ...
        Y_pred = create_conv_net(self.X, image_z, image_width, image_height, channels, n_class,
